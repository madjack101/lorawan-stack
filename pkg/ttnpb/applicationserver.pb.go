...
func (*ApplicationLink) Descriptor() ([]byte, []int) {
	return fileDescriptor_applicationserver_49f5a17af643d5cc, []int{0}
}
...
func (*GetApplicationLinkRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_applicationserver_49f5a17af643d5cc, []int{1}
}
...
func (*SetApplicationLinkRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_applicationserver_49f5a17af643d5cc, []int{2}
}
...
func (*ApplicationLinkStats) Descriptor() ([]byte, []int) {
	return fileDescriptor_applicationserver_49f5a17af643d5cc, []int{3}
}
...
func init() {
	proto.RegisterFile("lorawan-stack/api/applicationserver.proto", fileDescriptor_applicationserver_49f5a17af643d5cc)
}
func init() {
	golang_proto.RegisterFile("lorawan-stack/api/applicationserver.proto", fileDescriptor_applicationserver_49f5a17af643d5cc)
}

var fileDescriptor_applicationserver_49f5a17af643d5cc = []byte{
